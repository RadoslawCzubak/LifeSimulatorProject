...
/**
 * Klasa odpowiada za wyœwietlanie okna symulacji oraz zarz¹daniem jej dzia³ania.
 * Wyœwietla menu, okno ustawieñ oraz rozpoczyna symulacjê.
...
public class SimulationFrame extends JFrame implements ActionListener{
	...
	/**
	 * Konstruktor
	 * Tworzy sk³adowe klasy:
	 * Timer, 
	 * Wyœwietlacz symulacji (SimulationDisplay) ,
	 * Menu, 
	 * Layout
	 */
	public SimulationFrame()
	{
		super("SimpleLifeSimulation v1.0.0");
